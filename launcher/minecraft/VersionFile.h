...
class VersionFile : public ProblemContainer {
   ...
   public: /* data */
    /// J3Launcher: order hint for this version file if no explicit order is set
    int order = 0;

    /// J3Launcher: human readable name of this package
    QString name;

    /// J3Launcher: package ID of this package
    QString uid;

    /// J3Launcher: version of this package
    QString version;

    /// J3Launcher: DEPRECATED dependency on a Minecraft version
    ...
    /// J3Launcher: class to launch legacy Minecraft with (embed in a custom window)
    QString appletClass;

    /// Mojang: Minecraft launch arguments (may contain placeholders for variable substitution)
    QString minecraftArguments;

    /// J3Launcher: Additional JVM launch arguments
    ...
    /// J3Launcher: list of tweaker mod arguments for launchwrapper
    QStringList addTweakers;

    /// Mojang: list of libraries to add to the version
    QList<LibraryPtr> libraries;

    /// J3Launcher: list of maven files to put in the libraries folder, but not in classpath
    QList<LibraryPtr> mavenFiles;

    /// J3Launcher: list of agents to add to JVM arguments
    QList<Agent> agents;

    /// The main jar (Minecraft version library, normally)
    LibraryPtr mainJar;

    /// J3Launcher: list of attached traits of this version file - used to enable features
    QSet<QString> traits;

    /// J3Launcher: list of jar mods added to this version
    QList<LibraryPtr> jarMods;

    /// J3Launcher: list of mods added to this version
    QList<LibraryPtr> mods;

    /**
     * J3Launcher: set of packages this depends on
     * NOTE: this is shared with the meta format!!!
     */
    Meta::RequireSet m_requires;

    /**
     * J3Launcher: set of packages this conflicts with
     * NOTE: this is shared with the meta format!!!
     */
