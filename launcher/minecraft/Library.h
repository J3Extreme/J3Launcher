...
class Library {
   ...
   private: /* methods */
    /// the default storage prefix used by J3Launcher
   ...
   protected: /* data */
    ...
    /// DEPRECATED: J3Launcher-specific absolute URL. takes precedence over the implicit maven repo URL, if defined
    QString m_absoluteURL;

    /// J3Launcher extension - filename override
    QString m_filename;

    /// DEPRECATED J3Launcher extension - display name
    QString m_displayname;

    /**
     * J3Launcher-specific type hint - modifies how the library is treated
     */
    QString m_hint;

    /**
     * storage - by default the local libraries folder in J3Launcher, but could be elsewhere
     * J3Launcher specific, because of FTB.
     */
