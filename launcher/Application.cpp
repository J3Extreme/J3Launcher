...
Application::Application(int& argc, char** argv) : QApplication(argc, argv)
{
    ...
    /*
     * Establish the mechanism for communication with an already running J3Launcher that uses the same data path.
    ...
    // Initialize application settings
    {
        ...
        m_settings->registerSetting("CustomBackgroundPath", QString());
